    ...
    return (
        <div className="fixed top-0 left-0 right-0 h-14 bg-[var(--bg-surface)] border-b border-[var(--border)] z-50 flex items-center justify-between px-6">
            <div className="flex items-center gap-3 cursor-pointer" onClick={onReset}>
                <span className="font-[Inter] font-bold text-[15px] text-[var(--text-primary)]">SleekScan</span>
            ...
            <div className="flex items-center gap-4">
                ...
                <button
                    ...
                    className="flex items-center gap-2 text-[13px] font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] bg-transparent hover:bg-[var(--bg-sunken)] px-3 py-1.5 rounded-lg transition-colors duration-200"
                >
                    <UploadCloud size={16} />
                    Upload
                </button>
